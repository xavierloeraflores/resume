...
\begin{zitemize}
     ...
     \end{zitemize}
%%%%%%% ------------------------------------------------------------------------------- %%%%%%%
\subsection*{Custodia AI {\normalsize \normalfont} \hfill  Jun 2024 --- Sep 2024 }
    \begin{zitemize}
    	\item{Cofounded an AI voice agents startup with 2 cofounders that specialized in LLM powered agents that communicate over the phone.}
