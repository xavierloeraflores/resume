...
%%%% Set White Color (FOR EDUCATION SECTION)
\definecolor{UI_white}{RGB}{255, 255, 255}
%%%% Set EDU Subtext Formatting (FOR EDUCATION SECTION)
\newcommand{\edusubtext}[1]{\vspace{-0.5cm}
{\fontsize{1pt}{0.1pt}{. \hfill \color{UI_white}{|}}} 
\par \parskip0pt \parsep1pt \itemsep0pt \hspace*{0pt} \vspace{-0.7cm}
}
...
\begin{zitemize}
       ...
       \item {Developed, trained, \& persisted 3 logistic regression machine learning models using Scikit-Learn that classify offensive text. } \\
...
%%%%%%% ------------------------------------------------------------------------------- %%%%%%%
\subsection*{Co-Founder, CTO {\normalsize \normalfont} \hfill  Jun 2024 --- Present }
\subtext{Custodia AI \hfill Remote }
    \begin{zitemize}
        \item Developing an AI-powered platform that enables small businesses to establish their own tailored custom customer service call center.
        \item Developed 2 award-winning apps, ScamScanner (Groq's "Star Award" \& Hume AI's "Most Socially Impactful Empathic AI Integration" at UC Berkeley AI Hackathon) \& Custodia AI (1st Place at AI Agents 2.0), securing spots to present at exclusive startup events \& podcasts.
    \end{zitemize}
...
%%%%%%% --------------------------------------------------------------------------------------
\section{Education}
\subsection*{ Masters's of Science in Data Science, {\normalsize \normalfont Western Governors University} \hfill Aug 2024 --- Jun 2025 }
\edusubtext{.}
