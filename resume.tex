...
%%%% Set Margins
\usepackage[margin=0.75cm, top=0.75cm, bottom=0.5cm]{geometry}
...
\section{Projects} %% (Or "Research", select as appropriate)
\subsection*{Machine Learning Social Media Racism Detector(In Progress), {\normalsize \normalfont \href{https://github.com/xavierloeraflores/wgu-capstone}{GitHub}} | \normalsize \normalfont \href{https://wgu-capstone-xavier-loera-flores.vercel.app/}{Live} \hfill} 
\begin{zitemize}
       \item {Developed a ML model leveraging Natural Language Processing (NLP) techniques with scikit-learn and NLTK to classify offensive posts. } \\
       \item {Engineered an end-to-end solution using FastAPI and Next.js, integrating the model to classify and moderate user generated content.} \\
     \end{zitemize}
