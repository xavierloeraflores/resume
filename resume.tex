...
{Dedicated and skilled software engineer with over 2.5 years of hands-on experience in developing robust and scalable applications within the Node.js/Next.js ecosystem. Seeking a challenging and impactful role where I contribute to the success of dynamic and forward-thinking teams.}
\vspace{-0.3cm}
...
%%%%%%% --------------------------------------------------------------------------------------
\section{Skills}
\hskills{Languages}: {Go/Golang, TypeScript, JavaScript, Java, Python, Swift, SQL (PostgreSQL, MySQL)}  \\
\hskills{Backend}: {Fiber, Node, Express, Next, Docker, REST, gRPC, JWT }  \\
\hskills{Frontend}: {Next.js, React, Svelte, SvelteKit, TailwindCSS, HUGO, HTML, CSS} \\
\hskills{Tools}: {Git, Docker, AWS (EC2, S3), GitHub Actions, Vercel, Netlify, Insomnia, Postman} \\
\vspace{-0.2cm}
